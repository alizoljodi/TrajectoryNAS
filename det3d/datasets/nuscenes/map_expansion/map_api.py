...
class NuScenesMap:
    ...
    def __init__(
        ...
        self.json_fname = os.path.join(
            self.dataroot, "maps", "{}.json".format(self.map_name)
        )
        ...
        if self.version < "1.2":
            raise Exception(
                "Error: You are using an outdated map version! "
    ...
    def _load_arcline_path(
        self,
    ) -> Dict[str, List[ArcLinePath]]:
        """
    ...
    def render_record(
        ...
        return self.explorer.render_record(
            layer_name, token, alpha, figsize, other_layers
        )
    ...
    def render_map_in_image(
        ...
        """
        self.explorer.render_map_in_image(
            nusc,
            sample_token,
