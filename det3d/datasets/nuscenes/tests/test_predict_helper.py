...
class Test_convert_coords(unittest.TestCase):
    ...
    def test_heading_0(self):
        ...
        np.testing.assert_allclose(
            convert_local_coords_to_global(answer, origin, rotation),
            self.along_pos_x,
            atol=1e-4,
        )

        answer = convert_global_coords_to_local(
            self.along_pos_x + [[50, 25]], offset, rotation
        )
        np.testing.assert_allclose(answer, self.along_pos_y, atol=1e-4)
        np.testing.assert_allclose(
            convert_local_coords_to_global(answer, offset, rotation),
        ...
        answer = convert_global_coords_to_local(
            self.along_pos_y + [[50, 25]], offset, rotation
        )
        np.testing.assert_allclose(answer, self.along_neg_x, atol=1e-4)
        np.testing.assert_allclose(
            convert_local_coords_to_global(answer, offset, rotation),
        ...
        answer = convert_global_coords_to_local(
            self.along_neg_x + [[50, 25]], offset, rotation
        )
        np.testing.assert_allclose(answer, self.along_neg_y, atol=1e-4)
        np.testing.assert_allclose(
            convert_local_coords_to_global(answer, offset, rotation),
        ...
        answer = convert_global_coords_to_local(
            self.along_neg_y + [[50, 25]], offset, rotation
        )
        np.testing.assert_allclose(answer, self.along_pos_x, atol=1e-4)
        np.testing.assert_allclose(
            convert_local_coords_to_global(answer, offset, rotation),
    ...
    def test_heading_pi_over_4(self):
        ...
        answer = convert_global_coords_to_local(self.along_pos_y, origin, rotation)
        np.testing.assert_allclose(
            answer, self.y_equals_x * [[-np.sqrt(2) / 2, np.sqrt(2) / 2]], atol=1e-4
        )
        np.testing.assert_allclose(
            convert_local_coords_to_global(answer, origin, rotation),
            self.along_pos_y,
...
class TestPredictHelper(unittest.TestCase):
    ...
    def test_get_sample_annotation(
        self,
    ):
        ...
        self.assertDictEqual(
            mock_annotation, helper.get_sample_annotation("instance_1", "sample_1")
        )

    def test_get_future_for_agent_exact_amount(
        self,
    ):
    ...
    def test_get_future_for_agent_less_amount(
        self,
    ):
    ...
    def test_get_future_for_agent_within_buffer(
        self,
    ):
    ...
    def test_get_future_for_agent_no_data_to_get(
        self,
    ):
        mock_samples = [
            {"token": "1", "timestamp": 0},
    ...
    def test_get_past_for_agent_exact_amount(
        self,
    ):
    ...
    def test_get_past_for_agent_in_frame(
        self,
    ):
        ...
        np.testing.assert_allclose(
            past, np.array([[1.0, -1.0], [2.0, -2.0], [3.0, -3.0]])
        )

    def test_get_past_for_agent_less_amount(
        self,
    ):
    ...
    def test_get_past_for_agent_within_buffer(
        self,
    ):
    ...
    def test_get_past_for_agent_no_data_to_get(
        self,
    ):
        mock_samples = [
            {"token": "5", "timestamp": 0},
    ...
    def test_acceleration_nonzero(self):
        ...
        self.assertAlmostEqual(
            helper.get_acceleration_for_agent("1", "3"), 2 * (np.sqrt(32) - np.sqrt(8))
        )
    ...
    def test_get_no_data_when_seconds_0(self):
        ...
        np.testing.assert_equal(
            helper.get_past_for_agent("1", "1", 0, False), np.array([])
        )
        np.testing.assert_equal(
            helper.get_future_for_sample("1", 0, False), np.array([])
        )
