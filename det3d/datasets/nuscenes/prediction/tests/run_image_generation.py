...
class TestDataset(Dataset):
    ...
    def __getitem__(self, index: int):
        ...
        image = self.static_layer_representation.make_representation(
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Makes sure image generation code can run on gpu "
    ...
    tokens = [
        "bd26c2cdb22d4bb1834e808c89128898_ca9a282c9e77460f8360f564131a8af5",
