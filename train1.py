...
parser.add_argument(
    "--rootDirectory", default="/media/asghar/media/NUSCENES_DATASET_ROOT_MINI"
)
...
det_dir = "/media/asghar/media/FutureDetNAS/models/{experiment}/{dataset}_{architecture}_{model}_detection7_test".format(
    architecture=architecture, experiment=experiment, model=model, dataset=dataset
)

track_dir = "models/{experiment}/{dataset}_{architecture}_{model}_tracking".format(
    architecture=architecture, experiment=experiment, model=model, dataset=dataset
)
